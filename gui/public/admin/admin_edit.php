...
{
	SELITY_Events_Manager::getInstance()->dispatch(SELITY_Events::onBeforeEditUser, array('userId' => $userId));
	...
	SELITY_Events_Manager::getInstance()->dispatch(SELITY_Events::onAfterEditUser, array('userId' => $userId));
